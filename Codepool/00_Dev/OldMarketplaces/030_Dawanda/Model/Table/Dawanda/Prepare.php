...
class ML_Dawanda_Model_Table_Dawanda_Prepare extends ML_Database_Model_Table_Prepare_Abstract {
    ...
    protected $aFields = array ( 
        ...
        'PrepareType' => array(
            'Type' => "enum('apply','manual','auto')", 'Null' => 'NO', 'Default' => NULL, 'Extra' => '', 'Comment'=>''
        ),
        'Verified' => array (
        ...
        'ShippingTime' => array (
            'Type' => 'varchar(4)', 'Null' => 'NO', 'Default' => NULL, 'Extra' => '', 'Comment'=>''
        ), 
    );
    ...
    protected function getTopMarketplaceCategories ($sClass, $sField) {
        ...
        return $this->getTopCategories($sClass, $sField, "language = '". MLDatabase::getDbInstance()->escape($sMainLang)."'");
    }
    ...
    public function getTopStoreCategories () {
        return $this->getTopCategories('dawanda_categoriesstore', 'topstorecategory', "mpid = '" . MLModule::gi()->getMarketPlaceId() . "'");
    }
