...
class ML_Crowdfox_Controller_Crowdfox_Config_Prepare extends ML_Form_Controller_Widget_Form_ConfigAbstract {

    public static function getTabTitle() {
        return MLI18n::gi()->get('crowdfox_config_account_prepare');
    }
    ...
    public function gtincolumnField(&$aField) {
    ...
    public function shippingmethodField(&$aField) {
        $aField['values'] = array_merge(array('' => MLI18n::gi()->ConfigFormEmptySelect),
            $this->callApi(array('ACTION' => 'GetShippingMethod'), 60));
    }
