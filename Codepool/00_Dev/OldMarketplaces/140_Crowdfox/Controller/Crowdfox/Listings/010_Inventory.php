...
class ML_Crowdfox_Controller_Crowdfox_Listings_Inventory extends ML_Listings_Controller_Widget_Listings_InventoryAbstract
{
    ...
    protected function getFields()
    {
        ...
        return array(
            'SKU' => array(
                'Label' => $oI18n->CROWDFOX_ML_LABEL_ARTICLE_SKU,
                'Sorter' => 'sku',
                'Getter' => 'getSku',
                'Field' => null,
            ),
            ...
            'Title' => array(
                'Label' => $oI18n->CROWDFOX_ML_LABEL_ARTICLE_NAME,
                'Sorter' => 'title',
                'Getter' => 'getTitle',
                'Field' => null,
            ),
            'ProductId' => array(
                'Label' => $oI18n->crowdfox_label_item_id,
                'Sorter' => 'productid',
                'Getter' => 'getProductId',
                'Field' => null,
            ),
            'ShopPrice' => array(
                'Label' => $oI18n->CROWDFOX_ML_LABEL_ARTICLE_SHOP_PREIS,
                'Sorter' => 'price',
                'Getter' => 'getItemPrice',
                'Field' => null,
            ),
            'Quantity' => array(
                'Label' => $oI18n->CROWDFOX_ML_LABEL_ARTICLE_MARKETPLACE_QUANTITY,
                'Sorter' => 'quantity',
            ...
            'Status' => array(
                'Label' => MLI18n::gi()->crowdfox_inventory_listing_status,
                'Sorter' => null,
                'Getter' => 'getStatus',
                'Field' => null,
            )
