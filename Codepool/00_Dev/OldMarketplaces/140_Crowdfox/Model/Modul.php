 ...
 * -----------------------------------------------------------------------------
 */
class ML_Crowdfox_Model_Modul extends ML_Modul_Model_Modul_Abstract {
    ...
    public function getMarketPlaceName($blIntern = true) {
        return $blIntern ? 'crowdfox' : MLI18n::gi()->get('sModuleNameCrowdfox');
    }

    public function getOrderLogo(ML_Shop_Model_Order_Abstract $oOrder) {
        return 'crowdfox_orderview.png';
    }
