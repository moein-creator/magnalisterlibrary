...
class ML_Bepado_Helper_Model_Service_Product {
    ...
    protected function getPrice() {
        return $this->oVariant->getSuggestedMarketplacePrice(MLModule::gi()->getPriceObject('b2c'));
    }
    
    protected function getPurchasePrice() {
        return $this->oVariant->getSuggestedMarketplacePrice(MLModule::gi()->getPriceObject('b2b'), false);
    }
