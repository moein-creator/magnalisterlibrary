...
MLI18n::gi()->{'tradoria_config_price__field__exchangerate_update__help'} = 'Active: If the Shop currency differs from the Marketplace currency, the price will be automatically calculated based on the "alphavantage" exchange rate at the time.<br /><br />
