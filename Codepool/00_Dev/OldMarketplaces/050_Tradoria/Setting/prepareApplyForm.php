 ...
 * -----------------------------------------------------------------------------
 */
MLSetting::gi()->tradoria_prepare_apply_form = array(
//    'categories' => array(
//        'fields' => array(
//            array(
//                'name' => 'categories',
    ...
    'shipping' => array(
        'fields' => array(
            array(
                'name' => 'shippingtime',
                'type' => 'select',
                'values' => '{#i18n:tradoria_prepare_apply_form__field__shippingtime__values#}',
            ),
        ),
    ),
);

MLSetting::gi()->tradoria_prepare_variations = array(
    'variations' => array(
        'fields' => array(
            array(
                'name' => 'variationgroups',
