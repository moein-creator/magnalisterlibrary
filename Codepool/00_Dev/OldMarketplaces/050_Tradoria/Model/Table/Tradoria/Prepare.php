...
class ML_Tradoria_Model_Table_Tradoria_Prepare extends ML_Database_Model_Table_Prepare_Abstract {
    ...
    protected $aFields = array(
        ...
        'ShippingTime' => array(
            'Type' => 'int(3)', 'Null' => 'YES', 'Default' => NULL, 'Extra' => '', 'Comment' => ''
        ),
    ...
    public function getTopStoreCategories() {
        return $this->getTopCategories('tradoria_categoriesstore', 'topstorecategory', "mpid = '" . MLModule::gi()->getMarketPlaceId() . "'");
    }
