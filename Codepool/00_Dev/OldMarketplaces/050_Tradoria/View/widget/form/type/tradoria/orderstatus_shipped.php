    ...
    <?php
        ...
        foreach ($aField['subfields'] as $aCurrentField) {
            ...
            ?>
                <tr>
                    <?php if ($i == 1) { ?>
                        <td style="border:none;"><?php echo $aField['i18n']['name']; ?>:</td>
...
<style>
    #tradoria_config_orderimport_field_orderstatus_shipped_duplicate div {
        display: flex;
        border: 0 !important;
    }

    #tradoria_config_orderimport_field_orderstatus_shipped_duplicate div div {
    ...
    #tradoria_config_orderimport_field_orderstatus_shipped_duplicate div span {
        border: 0 !important;
    }
</style>
