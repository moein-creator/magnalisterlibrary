...
class ML_Tradoria_Helper_Model_Table_Tradoria_PrepareData extends ML_Form_Helper_Model_Table_PrepareData_Abstract{
    ...
    protected function variationGroups_ValueField(&$aField) {
        ...
        if (!isset($aField['value']) || $aField['value'] === '') {
            $this->aErrors[] = 'tradoria_prepareform_category';
        }
    }
    ...
    protected function shippingTimeField(&$aField) {
        $aField['value'] = $this->getFirstValue($aField) === null ? MLModule::gi()->getConfig('checkin.leadtimetoship') : $this->getFirstValue($aField);
    }
}