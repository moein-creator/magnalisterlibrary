...
class ML_Tradoria_Helper_Model_Service_Product
{
    ...
    {
        return $this->oPrepare->get('shippingtime') === null ? MLModule::gi()->getConfig('checkin.leadtimetoship') : $this->oPrepare->get('shippingtime');
    }

    protected function getShippingGroup()
    {
        return MLModule::gi()->getConfig('checkin.shippinggroup');
    }
