                    ...
                    oFinalButtons       : {
                        oError      : [
                            {text:'Ok',click:function(){
                                    window.location.href = '<?php $sMpId = MLModule::gi()->getMarketPlaceId();$sMpName = MLModule::gi()->getMarketPlaceName();echo $this->getUrl(array('controller' => "{$sMpName}:{$sMpId}_errorlog")); ?>';
                            }}
                        ],
                        oSuccess    : [
                            {text:'Ok',click:function(){
