...
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bactive__notification'} = 'Pour pouvoir utiliser Amazon Business, vous devez l\'activer sur votre compte Amazon. <b>Veuillez vous assurer, que sur votre compte Amazon, l\'option Amazon business est bien activée. </b>Si ce n\'est pas le cas, le téléchargement des articles B2B entraînera des messages d\'erreurs. <br> Pour activer votre compte Amazon Business, veuillez suivre les indications de cette <a href="https://sellercentral.dummymodule.fr/business/b2bregistration" target="_blank">page</a>.';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bactive__values__true'} = 'Oui';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bactive__values__false'} = 'Non';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.tax_code__label'} = 'TVA commerciale - Appariement ';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.tax_code__hint'} = '';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.tax_code__matching__titlesrc'} = 'TVA Boutique';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.tax_code__matching__titledst'} = 'TVA Amazon Business';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.tax_code_container__label'} = 'TVA commerciale par catégorie - Appariement';
...
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.tax_code_specific__matching__titlesrc'} = 'TVA Boutique';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.tax_code_specific__matching__titledst'} = 'TVA Amazon Business';
...
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bsellto__label'} = 'Vendu à';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bsellto__help'} = 'Si vous choisissez l\'option <i>B2B uniquement</i>, ne seront téléchargé que les produits compatibles avec ce marché. ';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bsellto__values__b2b_b2c'} = 'B2B et B2C';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bsellto__values__b2b_only'} = 'B2B uniquement';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.price__label'} = 'Prix Business';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.price__help'} = 'Indiquez un pourcentage, un prix fixe ou une remise. Les remises doivent être précédées du signe moins.';
...
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.price.signal__label'} = 'Champ décimal';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.price.signal__hint'} = 'Champ décimal';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.price.signal__help'} = 'Cette zone de texte sera utilisée dans les transmissions de données vers la place de Amazon, (prix après la virgule).<br/><br/>
...
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.priceoptions__label'} = 'Option prix du programme Business';
...
MLI18n::gi()->{'dummymodule_config_prepare__field__b2b.price.usespecialoffer__label'} = 'Utiliser aussi les prix spéciaux';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttype__label'} = 'Calcul des prix';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttype__help'} = '<b>Calcul des prix</b><br>
...
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttype__values__'} = 'Ne pas tenir compte';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttype__values__percent'} = 'Pourcentage';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier1__label'} = 'Prix plancher 1';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier2__label'} = 'Prix plancher 2';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier3__label'} = 'Prix plancher 3';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier4__label'} = 'Prix plancher 4';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier5__label'} = 'Prix plancher 5';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier1quantity__label'} = 'Nombre de pièce';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier2quantity__label'} = 'Nombre de pièce';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier3quantity__label'} = 'Nombre de pièce';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier4quantity__label'} = 'Nombre de pièce';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier5quantity__label'} = 'Nombre de pièce';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier1discount__label'} = 'Remise';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier2discount__label'} = 'Remise';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier3discount__label'} = 'Remise';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier4discount__label'} = 'Remise';
MLI18n::gi()->{'dummymodule_config_prepare__field__b2bdiscounttier5discount__label'} = 'Remise';
...
MLI18n::gi()->{'dummymodule_config_orderimport__field__orderstatus.sync__label'} = 'Synchronisation  ';
