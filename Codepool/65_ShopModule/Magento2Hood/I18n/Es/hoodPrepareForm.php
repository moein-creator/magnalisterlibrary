...
MLI18n::gi()->{'hood_prepare_form__field__title__optional__checkbox__labelNegativ'} = 'Toma siempre el último nombre de artículo de la tienda web';
MLI18n::gi()->{'hood_prepare_form__field__title__hint'} = 'Título máx. 80 caracteres';
MLI18n::gi()->{'hood_prepare_apply_form__field__description__hint'} = '
        ...
        <dl>
            ...
            <dt>#PESO#</dt><dd>Peso del producto</dd>
            <dt>#PROPIEDADES#</dt>
            ...
            <dt>Magento arttibutes también están disponibles. Estos se pueden integrar de acuerdo con el siguiente patrón:</dt
            <dd>
