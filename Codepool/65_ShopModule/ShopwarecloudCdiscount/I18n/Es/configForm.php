...
<ul>
    ...
    <li>
        ...
        <p>{#i18n:shop_order_attribute_creation_instruction#}<br>
            <br>
            Esta opción es útil si deseas utilizar <strong>diferentes empresas de transporte</strong> para los pedidos de Cdiscount.
        </p>
    </li>
    <li>
        ...
        <p>Puedes hacer coincidir las empresas de transporte recomendadas por Cdiscount con los proveedores de servicios creados en el módulo de gastos de envío de Shopware. Puedes realizar múltiples coincidencias utilizando el símbolo "+".<br>
            <br>
            Para obtener información sobre qué entrada del módulo de gastos de envío de Shopware se utiliza para la importación de pedidos de Cdiscount, consulta el icono de información en "Importación de pedidos" -> "Forma de envío de los pedidos".<br>
            <br>
            Esta opción es útil si deseas utilizar <strong>configuraciones de método de envío existentes</strong> del módulo de gastos de envío de <strong>Shopware</strong>.<br>
        </p>
    </li>
    <li>
        <span class="bold underline">magnalister añade un campo de texto libre en los detalles del pedido</span>.
        <p>Si selecciona esta opción, magnalister añadirá un campo en los detalles del pedido del pedido Shopware. En este campo puedes introducir la empresa de transporte.<br>
            <br>
...
<ul>
    ...
    <li>El hecho de no facilitar la empresa de transporte puede suponer la retirada temporal de la autorización de venta.</li>
    <li>La empresa de transporte es obligatoria para la confirmación de los envíos en Cdiscount.</li>
</ul>
';
