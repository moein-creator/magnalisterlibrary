...
Sie können die von Amazon empfohlenen Transportunternehmen mit den im PrestaShop Versandkosten-Modul angelegten Dienstleistern matchen. Über das “+” Symbol können Sie mehrere Matchings vornehmen.<br>
<br>
Infos, welcher Eintrag aus dem PrestaShop Versandkosten-Modul beim Amazon Bestellimport verwendet wird, entnehmen Sie bitte dem Info Icon unter “Bestellimport” -> “Versandart der Bestellungen”.<br>
<br>
Diese Option bietet sich an, wenn Sie auf <strong>bestehende Versandkosten-Einstellungen</strong> aus dem <strong>PrestaShop</strong> Versandkosten-Modul zurückgreifen möchten.<br>
<ul>
    <li><span class="bold underline">magnalister fügt ein Freitextfeld in den Bestelldetails hinzu</span></li>
</ul>
Wenn Sie diese Option wählen, fügt magnalister beim Bestellimport ein Feld in den Bestelldetails bei der PrestaShop Bestellung hinzu. In dieses Feld können Sie das Transportunternehmen eintragen.<br>
<br>
...
Sie können einen beliebigen Lieferservice mit den im PrestaShop Versandkosten-Modul angelegten Einträgen matchen. Über das “+” Symbol können Sie mehrere Matchings vornehmen.<br>
<br>
Infos, welcher Eintrag aus dem PrestaShop Versandkosten-Modul beim Amazon Bestellimport verwendet wird, entnehmen Sie bitte dem Info Icon unter “Bestellimport” -> “Versandart der Bestellungen”.<br>
<br>
Diese Option bietet sich an, wenn Sie auf <strong>bestehende Versandkosten-Einstellungen aus</strong> dem <strong>PrestaShop</strong> Versandkosten-Modul zurückgreifen möchten.<br>
<ul>
	<li><span class="bold underline">magnalister fügt ein Freitextfeld in den Bestelldetails hinzu</span></li>
</ul>
Wenn Sie diese Option wählen, fügt magnalister beim Bestellimport ein Feld in den Bestelldetails bei der PrestaShop Bestellung hinzu. In dieses Feld können Sie den Lieferservice eintragen.<br>
<br>
