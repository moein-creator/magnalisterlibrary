...
class ML_ShopwareGoogleShopping_Helper_Model_Table_GoogleShopping_ConfigData extends ML_Googleshopping_Helper_Model_Table_GoogleShopping_ConfigData {
    ...
    public function orderimport_shippingmethodField(&$aField) {
        $aField['values'] =
            array('GoogleShopping' => 'GoogleShopping')
