...
class ML_ShopwareCloudEbay_Helper_Model_Service_OrderData_Normalize extends ML_Ebay_Helper_Model_Service_OrderData_Normalize {
    ...
    protected function normalizeOrder() {
        ...
        if (isset($this->aOrder['Order']['Payed']) && $this->aOrder['Order']['Payed']) {
            ...
            $this->aOrder['Order']['PaymentStatus'] = 'open';
        }
        return $this;
    }
