...
<dl>
    ...
    <dt>#PICTURE2# usw.</dt>
            <dd>zweites Produktbild; mit #PICTURE3#, #PICTURE4# usw. k&ouml;nnen weitere Bilder &uuml;bermittelt werden, so viele wie im Shop vorhanden.</dd>'
                .'<br><dt>Artikel-Zusatzfelder:</dt><br>'
                .'<dt>#Bezeichnung1#&nbsp;#Zusatzfeld1#</dt>'
                .'<dt>#Bezeichnung2#&nbsp;#Zusatzfeld2#</dt>'
                .'<dt>#Bezeichnung..#&nbsp;#Zusatzfeld..#</dt><br>'
                .'<dd>&Uuml;bernahme der Artikel-Zusatzfelder:&nbsp;'
                .'Die Ziffer hinter dem Platzhalter (z.B. #Zusatzfeld1#) entspricht der Position des Zusatzfelds.
                <br> Siehe Einstellungen > Grundeinstellungen > Artikel > Artikel-Zusatzfelder</dd><br>'
        .'<dt>#PROPERTIES#</dt>'
