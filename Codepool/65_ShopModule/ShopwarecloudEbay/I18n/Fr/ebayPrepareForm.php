...
MLI18n::gi()->{'ebay_prepare_apply_form__field__description__hint'} = 'Liste des champs de texte libre disponibles pour la description de l’article : <br>
<br>
#TITLE#<br>
<BLOCKQUOTE>
<p>nom du produit</p>
...
<br>
#Description1# #Customfield1#<br>
#Description2# #Customfield2#<br>
#description12# #Customfield1#<br>
<br>
...
';
MLI18n::gi()->{'ebay_prepare_apply_form__field__description__optional__checkbox__labelNegativ'} = 'Toujours reprendre la description d\'article de votre boutique en ligne';
