...
MLI18n::gi()->{'hood_config_orderimport__field__updateablepaymentstatus__help'} = 'Estado de los pedidos que se puede cambiar para los pagos de Hood.de.
			                ...
			                Si no desea que el estado del pago se modifique en absoluto para los pagos de Hood.de, desactive la casilla de verificación.';
...
Por defecto: "Transferencia desde el mercado"</p> <p>.
<p>
Si selecciona "Adoptar del mercado", magnalister adopta el método de envío seleccionado por el comprador en Hood.de.
Esto también se crea entonces en Shopware > Configuración > Gastos de envío.</p> <p>
<p>
