...
class ML_ShopwarecloudHood_Helper_Model_Table_Hood_ConfigData extends ML_Hood_Helper_Model_Table_Hood_ConfigData {
    ...
    public function orderstatus_carrier_defaultField(&$aField) {
        $aField['values'] = array('-1' => MLI18n::gi()->get('shopware_orderstatus_carrier_defaultField_value_shippingname'));
