...
class ML_PrestashopGoogleShopping_Model_ProductList_GoogleShopping_Prepare_Match extends ML_Prestashop_Model_ProductList_Abstract {
    ...
    protected function executeFilter() {
        $this->oFilter
                ...
                ->registerDependency('googleshoppingpreparetypefilter', array('PrepareType' => 'match'))
