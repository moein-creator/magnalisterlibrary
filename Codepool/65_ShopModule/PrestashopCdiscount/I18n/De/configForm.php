...
<ul>
    ...
    <li>
        ...
        <p>Sie können die von Cdiscount empfohlenen Transportunternehmen mit den im PrestaShop Versandkosten-Modul angelegten Dienstleistern matchen. Über das “+” Symbol können Sie mehrere Matchings vornehmen.<br>
            <br>
            Infos, welcher Eintrag aus dem PrestaShop Versandkosten-Modul beim Cdiscount Bestellimport verwendet wird, entnehmen Sie bitte dem Info Icon unter “Bestellimport” -> “Versandart der Bestellungen”.<br>
            <br>
            Diese Option bietet sich an, wenn Sie auf <strong>bestehende Versandart-Einstellungen</strong> aus dem <strong>PrestaShop</strong> Versandkosten-Modul zurückgreifen möchten.<br>
        </p>
    </li>
    <li>
