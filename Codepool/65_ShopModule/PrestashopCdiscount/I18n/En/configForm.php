...
<ul>
    ...
    <li>
        ...
        <p>You can match the shipping carriers suggested by Cdiscount with the service providers created in the PrestaShop shipping module. Add more than one match by clicking the "+" symbol.<br>
            <br>
            For information on which entry from the PrestaShop shipping module is used for the Cdiscount order import, please refer to the info icon under "Order Import" -> "Shipping Service of the Orders".<br>
            <br>
    ...
    <li>
        ...
        <p>If you select this option, magnalister will add a field in the order details of the PrestaShop order when importing it. You can enter the shipping carrier in this field.<br>
            <br>
