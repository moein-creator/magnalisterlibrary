...
MLI18n::gi()->add('check24_config_orderimport', array(
    'field' => array(
        'orderimport.paymentmethod' => array(
            ...
            'help' => '
                <p>Zahlart, die allen Check24-Bestellungen beim Bestellimport zugeordnet wird.</p>
        ...
        'orderimport.shippingmethod' => array(
            ...
            'help' => '
                <p>Check24 &uuml;bergibt beim Bestellimport keine Information der Versandart.</p>
...
MLI18n::gi()->{'check24_config_price__field__priceoptions__help'} = '<p>Mit dieser Funktion k&ouml;nnen Sie abweichende Preise zu {#setting:currentMarketplaceName#} &uuml;bergeben und automatisch synchronisieren lassen.</p>
