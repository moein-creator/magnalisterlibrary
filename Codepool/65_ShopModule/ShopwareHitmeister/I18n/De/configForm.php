...
MLI18n::gi()->add('hitmeister_config_orderimport', array(
    'field' => array(
        'orderimport.paymentmethod'  => array(
            ...
            'help'  => '<p>Zahlart, die allen Kaufland.de-Bestellungen beim Bestellimport zugeordnet wird. 
<p>
...
Diese Einstellung ist wichtig f&uuml;r den Rechnungs- und Lieferscheindruck, und f&uuml;r die nachtr&auml;gliche Bearbeitung der Bestellung im Shop, sowie in Warenwirtschaften.
        ...
        'orderimport.shippingmethod' => array(
            ...
            'help' => '<p>Versandart, die allen Kaufland.de-Bestellungen beim Bestellimport zugeordnet wird. </p>
...
MLI18n::gi()->{'hitmeister_config_price__field__priceoptions__help'} = '<p>Mit dieser Funktion k&ouml;nnen Sie abweichende Preise zu {#setting:currentMarketplaceName#} &uuml;bergeben und automatisch synchronisieren lassen.</p>
