...
MLI18n::gi()->{'formfields__orderimport.shippingmethod__help'} = '<p>Idealo no proporciona ninguna información sobre el método de envío al importar pedidos.</p>
...
MLI18n::gi()->{'formfields__orderimport.paymentmethod__help'} = '<p>Método de pago que se asigna a todos los pedidos de Idealo durante la importación de pedidos.
Por defecto: "{#i18n:marketplace_configuration_orderimport_payment_method_from_marketplace#}"</p> <p><strong>Método de pago</strong>".
<p>
...
MLI18n::gi()->{'formfields__orderimport.paymentstatus__help'} = '<p>Idealo no proporciona ninguna información sobre el método de envío al importar pedidos.</p> <p
