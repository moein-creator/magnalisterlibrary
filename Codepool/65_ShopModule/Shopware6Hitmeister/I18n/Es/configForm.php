...
MLI18n::gi()->{'hitmeister_config_orderimport__field__orderimport.paymentmethod__help'} = '<p>Método de pago que se asigna a todos los pedidos de Kaufland.de durante la importación del pedido.
<p>
