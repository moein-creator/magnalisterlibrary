...
MLI18n::gi()->{'hood_prepare_form__field__description__hint'} = 'Liste des champs de texte libre disponibles pour la description de l’article : <br>
<br>
#TITLE#<br>
<BLOCKQUOTE>
<p>nom du produit</p>
...
';
MLI18n::gi()->{'hood_prepare_form__field__description__optional__checkbox__labelNegativ'} = 'Toujours reprendre la description d\'article de votre boutique en ligne';
