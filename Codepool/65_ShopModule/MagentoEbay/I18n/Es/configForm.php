...
<div>#PROPIEDADES#</div>';
MLI18n::gi()->{'ebay_config_producttemplate__field__template.content__hint'} = '        Lista de marcadores de posición disponibles para la descripción del producto:
        <dl>
...
MLI18n::gi()->{'ebay_config_producttemplate__field__template.name__help'} = '<dl>
						<dt>Nombre del producto en eBay</dt>.
							<dd>Establecimiento de cómo debe llamarse el producto en eBay.
							El marcador de posición <b>#TITLE#</b> se sustituye automáticamente por el nombre del producto de la tienda.</dd>
			</dl>';
MLI18n::gi()->{'ebay_config_producttemplate__field__template.name__label'} = 'Plantilla del nombre del producto';
