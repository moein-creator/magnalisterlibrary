...
<p>Si seleccionas "Adoptar del marketplace", magnalister adopta el método de envío seleccionado por el comprador en Hood.de.
...
MLI18n::gi()->{'hood_config_orderimport__field__updateablepaymentstatus__help'} = 'Estado de los pedidos que se puede cambiar para los pagos de Hood.de.
			                Si el pedido tiene un estado diferente, no se modificará para los pagos de Hood.de.<br /><br />
			                Si no deseas que el estado del pago se modifique en absoluto para los pagos de Hood.de, desactiva la casilla de verificación.';
...
MLI18n::gi()->{'hood_config_orderimport__field__paidstatus__label'} = 'Hood.de estado de pago en la tienda';
MLI18n::gi()->{'hood_config_producttemplate__field__template.content__hint'} = '
...
<dl>
    ...
    <dt>#Imagen2# etc.</dt>
            <dd>segunda imagen del producto; con #Imagen3#, #Imagen4# etc. se pueden proporcionar más imágenes, tantas como estén disponibles en la tienda.</dd><br><dt>Campos de texto libre del artículo:</dt><br><dt>#Descripción1#&nbsp;#Campo de texto libre1#</dt><dt>#Descripción2#&nbsp;#Campo de texto libre2#</dt><dt>#Descripción..#&nbsp;#Campo de texto libre..#</dt><br><dd>&nbspEl número después del marcador de posición (por ejemplo #Campo de texto libre1#) corresponde a la posición del campo de texto libre.
                <br> Ver Ajustes > Ajustes básicos > Artículos > Campos de texto libre del artículo</dd><dt>#PROPIEDADES#</dt><dd>Una lista de todas las propiedades del producto. La apariencia se puede controlar mediante CSS (ver código de la plantilla estándar)</dd></dl>';
MLI18n::gi()->{'hood_config_orderimport__field__paidstatus__help'} = '<p>Aquí se configura el pago y el estado del pedido que recibe un pedido en la tienda en cuanto se paga en Hood.de con PayPal.</p> <p>Aquí se configura el pago y el estado del pedido que recibe un pedido en la tienda en cuanto se paga en Hood.de con PayPal.
<p>
Cuando un cliente realiza una compra en Hood.de, el pedido se transfiere inmediatamente a su tienda web.
La forma de pago se establece primero en "Hood.de", o el valor que haya almacenado en "Forma de pago de los pedidos".</p> <p>

<p>
magnalister seguirá supervisando durante 16 días si un comprador en Hood.de ha realizado un pago posterior o ha cambiado su dirección de envío después de la primera importación del pedido.
...
magnalister utiliza la información de Hood.de que también puede ver en su cuenta de Hood.de en "Actividad" > "Resumen" > "Sales Manager Pro" > "Vendido" en la 12ª columna (símbolo del euro): Un símbolo en negrita es la indicación de "pagado".
</p><br /><br />
