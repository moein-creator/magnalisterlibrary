...
class ML_PrestashopEtsy_Helper_Model_Service_Product extends ML_Etsy_Helper_Model_Service_Product {


    /**
     * for Prestashop: oPrepare->get('shopVariation') gives back shop variation keys
