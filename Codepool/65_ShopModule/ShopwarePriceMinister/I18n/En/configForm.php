 ...
 * -----------------------------------------------------------------------------
 */
MLI18n::gi()->{'priceminister_config_orderimport__field__orderimport.paymentmethod__label'} = 'Payment Methods';
MLI18n::gi()->{'priceminister_config_orderimport__field__orderimport.paymentmethod__help'} = '<p>Payment method that will apply to all orders imported from Rakuten.
<p>
...
MLI18n::gi()->{'priceminister_config_orderimport__field__orderimport.shippingmethod__help'} = '<p>Shipping service which will be assigned to all Rakuten orders within the order import</p>
...
MLI18n::gi()->{'priceminister_config_orderimport__field__paymentstatus__help'} = 'Please select which shop system payment status should be set in the order details during the magnalister order import.';
...
MLI18n::gi()->{'priceminister_config_price__field__priceoptions__help'} = '<p>With this function you can transfer different prices to the marketplace and synchronize them automatically.<br />
<br />
