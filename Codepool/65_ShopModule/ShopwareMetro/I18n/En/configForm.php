...
MLI18n::gi()->{'metro_config_orderimport__field__orderimport.paymentmethod__label'} = 'Payment Methods';
MLI18n::gi()->{'metro_config_orderimport__field__orderimport.paymentmethod__help'} = '<p>Payment method that will apply to all orders imported from METRO.
<p>
...
MLI18n::gi()->{'metro_config_orderimport__field__orderimport.shippingmethod__label'} = 'Shipping Service of the Orders';
MLI18n::gi()->{'metro_config_orderimport__field__orderimport.shippingmethod__help'} = '<p>METRO does not assign any shipping method to imported orders.</p>
