...
MLI18n::gi()->{'amazon_config_orderimport__field__orderimport.shippingmethod__help'} = '<b>Shipping Service of the Orders</b><br />
<br />
...
<ul>
	<li><span class="bold underline">Select a shipping carrier from a webshop free text field</span></li>
</ul>
You can create free text fields in your Shopware 5 backend under "Settings" -> "Free Text Field Management" (Table: Order) and fill them under "Customers" -> "Orders". To do this, open the corresponding order and scroll down to "Free Text Fields" in the order overview.<br>
<br>
...
You can match the shipping carriers suggested by Amazon with the service providers created in the Shopware 5 shipping module. Add more than one match by clicking the "+" symbol.<br>
<br>
...
<br>
Choose this option if you want to use <strong>existing shipping settings from the Shopware 5 shipping module</strong>.<br>
<ul>
...
You have the following options:
<ul>
	<li><span class="bold underline">Shipping method from webshop free text field for orders</span></li>
</ul>
You can create free text fields in your Shopware 5 backend under "Settings" -> "Free Text Field Management" (Table: Order) and fill them under "Customers" -> "Orders". To do this, open the corresponding order and scroll down to "Free Text Fields" in the order overview.<br>
<br>
...
You can match any shipping method with the entries created in the Shopware 5 shipping module. Add more than one match by clicking the "+" symbol.<br>
<br>
For information on which entry from the Shopware shipping module is used for the Amazon order import, please refer to the info icon under "Order Import" -> "Shipping Service of the Orders".<br>
<br>
Choose this option if you want to use <strong>existing shipping settings from the Shopware 5 shipping module.</strong><br>
