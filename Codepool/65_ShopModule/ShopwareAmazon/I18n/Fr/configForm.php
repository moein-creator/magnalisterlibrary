...
<ul>
	<li><span class="bold underline">Charger le transporteur depuis un champ libre</span></li>
</ul>
Vous pouvez créer des champs de texte libre dans votre backend Shopware 5 sous "Paramètres" -> "Gestion des champs de texte libre" (Tableau : Commande) et les remplir sous "Clients" -> "Commandes". Pour ce faire, ouvrez la commande correspondante et faites défiler vers le bas jusqu\'à "Champs de texte libre" dans l\'aperçu des commandes.<br>
<br>
Choisissez cette option si vous souhaitez <strong>utiliser différents transporteurs</strong> pour les commandes Amazon.
<ul>
...
Vous pouvez faire correspondre les transporteurs proposés par Amazon avec les transporteurs créés dans le module d\'expédition de Shopware 5. Pour ajouter un nouvel appariement, cliquez sur le symbole "+".<br>
<br>
...
<br>
Choisissez cette option si vous souhaitez <strong>utiliser les sociétés de livraisons existantes du module d\'expédition de Shopware 5.</strong><br>
<ul>
...
<ul>
	<li><span class="bold underline">Charger le service de livraison depuis un champ libre</span></li>
</ul>
Vous pouvez créer des champs de texte libre dans votre backend Shopware 5 sous "Paramètres" -> "Gestion des champs de texte libre" (Menu : Commande) et les remplir sous "Clients" -> "Commandes". Pour ce faire, ouvrez la commande correspondante et faites défiler vers le bas jusqu\'à \"Champs de texte libre\" dans l\'aperçu des commandes.<br>
<br>
Choisissez cette option si vous souhaitez <strong>utiliser différents services de livraison</strong> pour les commandes Amazon.<br>
<ul>
...
Vous pouvez faire correspondre les services de livraison proposés par Amazon avec les services de livraisons créés dans le module d\'expédition de Shopware 5. Pour ajouter un nouvel appariement, cliquez sur le symbole "+".<br>
<br>
Pour savoir quelle entrée du module d\'expédition de Shopware est utilisée pour l\'importation des commandes Amazon, veuillez vous référer à l\'icône info sous "Importation des commandes" -> "Service d\'expédition des commandes".<br>
<br>
Choisissez cette option si vous souhaitez <strong>utiliser les services d’expédition existants du module d’expédition de Shopware 5.</strong><br>
<ul>
