...
class ML_ShopwareIdealo_Helper_Model_Table_Idealo_ConfigData extends ML_Idealo_Helper_Model_Table_Idealo_ConfigData {
    
    public function orderimport_paymentmethodField (&$aField) {
        $aMatching = MLI18n::gi()->get('idealo_configform_orderimport_payment_values');
        $aField['values'] = 
