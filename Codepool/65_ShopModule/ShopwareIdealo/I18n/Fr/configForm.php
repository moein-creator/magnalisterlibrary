...
MLI18n::gi()->{'formfields__orderimport.paymentmethod__help'} = 'Mode de paiement assigné à toutes les commandes Idealo. Standard : « Idealo ».<br><br>
...
MLI18n::gi()->{'formfields__orderimport.shippingmethod__label'} = 'Mode d\'expédition des commandes';
MLI18n::gi()->{'formfields__orderimport.shippingmethod__help'} = '<p>Lors des importations des commandes, Idealo ne transmet pas d\'information sur le mode d\'expédition. </p>
...
MLI18n::gi()->{'formfields__orderimport.paymentstatus__label'} = 'Statut du paiement dans votre boutique';
MLI18n::gi()->{'formfields__orderimport.paymentstatus__help'} = 'Sélectionnez ici le statut de paiement qui sera automatiquement attribué aux commandes lors de l’importation des commandes depuis la place de marché.';
...
MLI18n::gi()->{'idealo_config_price__field__priceoptions__help'} = '<p>Avec cette fonction, vous pouvez transférer des prix divergents sur le marché et les faire synchroniser automatiquement.<br />
<br />
