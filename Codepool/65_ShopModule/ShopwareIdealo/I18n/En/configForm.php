 ...
 * -----------------------------------------------------------------------------
 */
MLI18n::gi()->{'idealo_config_carrier_option_group_shopfreetextfield_option_carrier'} = 'Shipping Carriers from webshop custom fields for orders';

MLI18n::gi()->{'formfields__orderimport.paymentmethod__label'} = 'Payment Methods';
MLI18n::gi()->{'formfields__orderimport.paymentmethod__help'} = '<p>Payment method that will apply to all orders imported from Idealo.
<p>
...
MLI18n::gi()->{'formfields__orderimport.shippingmethod__help'} = '<p>Idealo does not pass shipping service information with the order import</p>
...
MLI18n::gi()->{'formfields__orderimport.paymentstatus__help'} = 'Please select which shop system payment status should be set in the order details during the magnalister order import.';
...
MLI18n::gi()->{'idealo_config_price__field__priceoptions__help'} = '<p>With this function you can transfer different prices to the marketplace and synchronize them automatically.<br />
<br />
