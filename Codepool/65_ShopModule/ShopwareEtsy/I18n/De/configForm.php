...
MLI18n::gi()->add('formfields', array(
    'orderimport.paymentmethod' => array(
        ...
        'help' => '<p>Zahlart, die allen Etsy-Bestellungen beim Bestellimport zugeordnet wird. 
Standard: "Etsy"</p>
<p>
...
Diese Einstellung ist wichtig f&uuml;r den Rechnungs- und Lieferscheindruck, und f&uuml;r die nachtr&auml;gliche Bearbeitung der Bestellung im Shop, sowie in Warenwirtschaften.</p>',
    ...
    'orderimport.shippingmethod' => array(
        ...
        'help' => '<p>Etsy &uuml;bergibt beim Bestellimport keine Information der Versandart.</p>
...
MLI18n::gi()->{'etsy_config_price__field__priceoptions__help'} = '<p>Mit dieser Funktion k&ouml;nnen Sie abweichende Preise zu {#setting:currentMarketplaceName#} &uuml;bergeben und automatisch synchronisieren lassen.</p>
