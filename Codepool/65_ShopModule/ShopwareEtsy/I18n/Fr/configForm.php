...
MLI18n::gi()->{'formfields__orderimport.paymentmethod__help'} = 'Mode de paiement assigné à toutes les commandes Etsy. Standard : « Etsy ».<br><br>
...
MLI18n::gi()->{'formfields__orderimport.shippingmethod__help'} = '<p>Lors des importations des commandes, Etsy ne transmet pas d\'information sur le mode d\'expédition. </p>
...
MLI18n::gi()->{'etsy_config_price__field__priceoptions__help'} = '<p>Avec cette fonction, vous pouvez transférer des prix divergents sur le marché et les faire synchroniser automatiquement.<br />
<br />
