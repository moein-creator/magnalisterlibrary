...
MLI18n::gi()->{'amazon_config_carrier_option_group_shopfreetextfield_option_shipmethod'} = 'Selecciona el servicio de entrega en un campo adicional de la tienda web (pedidos)';
...
Selecciona aquí si deseas que magnalister genere su número de factura de anulación o si debe tomarse de un campo adicional de Shopware.
</p><p>
<b>Generar número de factura de anulación a través de magnalister</b>
</p><p>
magnalister genera números de factura de anulación consecutivos cuando se crea la factura. Puedes definir un prefijo que se coloca delante del número de factura. Ejemplo: R10000.
</p><p>
...
<b>Importante:</b><br/> magnalister genera y transmite la factura en cuanto el pedido se marca como enviado. Por favor, asegúrate de que el campo adicional se rellena en este momento, de lo contrario se generará un error (salida en la pestaña "Registro de errores").
<br/><br/>
Si utilizas la coincidencia del campo adicional, magnalister no se hace responsable de la creación correcta y consecutiva de números de factura de anulación.
</p>
';
MLI18n::gi()->{'amazon_config_vcs__field__amazonvcsinvoice.invoicenumber__help'} = '<p>
Selecciona aquí si desea que magnalister genere sus números de factura o si deben tomarse de un campo adicional de Shopware.
</p><p>
...
<b>Coincidir números de factura con campo adicional de Shopware</b>
</p><p>
Cuando se crea la factura, se adopta el valor del campo adicional de Shopware que hayas seleccionado.
</p><p>
{<i18n:shop_order_attribute_creation_instruction#}
...
<b>Importante:</b><br/> magnalister genera y transmite la factura en cuanto el pedido se marca como enviado. Por favor, asegúrate de que el campo adicional se rellena en este momento, de lo contrario se generará un error (salida en la pestaña "Registro de errores").
<br/><br/>
Si utilizas la coincidencia del campo adicional, magnalister no se hace responsable de la creación correcta y consecutiva de los números de factura.
</p>
';
MLI18n::gi()->{'amazon_config_orderimport__field__orderimport.paymentstatus__help'} = 'Seleccione aquí qué estado de pago de la tienda online debe almacenarse en los detalles del pedido durante la importación de pedidos de magnalister.';
MLI18n::gi()->{'amazon_config_amazonvcsinvoice_invoicenumberoption_values_matching'} = 'Correspondencia de los números de factura con el campo adicional';
...
<ul>
	<li><span class="negrita subrayada">{#i18n:amazon_config_carrier_option_group_shopfreetextfield_option_shipmethod#}</span>
        <p>
	...
	<li><span class="negrita subrayada">Coincidir el servicio de entrega con las entradas del módulo de envío de la tienda web</span>
        <p>
        Puede hacer coincidir cualquier servicio de entrega con las entradas creadas en el módulo de gastos de envío de Shopware. Puede hacer múltiples coincidencias utilizando el símbolo "+".<br>
        <br>
        Para obtener información sobre qué entrada del módulo de gastos de envío de Shopware se utiliza para la importación de pedidos de Amazon, consulte el icono de información en "Importación de pedidos" -> "Forma de envío de los pedidos".<br>
        <br>
        Esta opción es útil si desea utilizar <strong>configuraciones de gastos de envío existentes de</strong> el módulo de gastos de envío de <strong>Shopware</strong>.<br>
        </p>
    </li> <li
    <li><span class="negrita subrayada">magnalister añade un campo de texto libre en los detalles del pedido</span>.
        <p>
        Si selecciona esta opción, magnalister añade un campo en los detalles del pedido de Shopware durante la importación del pedido. En este campo puede introducir el servicio de entrega.<br>
        <br>
        Esta opción es útil si desea utilizar <strong>diferentes servicios de entrega</strong> para los pedidos de Amazon.<br>
        </p>
    </li> <li
	<li><span class="negrita subrayada">Introduzca manualmente un servicio de entrega para todos los pedidos en un campo de texto magnalister</span>.
        <p>
    
        Si selecciona esta opción en magnalister, puede introducir manualmente el nombre de un servicio de entrega en el campo de texto situado a la derecha del mismo.<br><br>
        <br>
...
<ul>
	...
	<li>El no proporcionar el servicio de entrega puede dar lugar a una retirada temporal de la autorización de venta.</li> <li>Las confirmaciones de envío son obligatorias.
</ul>
';
