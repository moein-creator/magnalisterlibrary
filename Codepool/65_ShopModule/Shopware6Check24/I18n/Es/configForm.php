...
MLI18n::gi()->{'check24_config_orderimport__field__orderimport.paymentmethod__help'} = '
                <p>Método de pago que se asigna a todos los pedidos de Check24 durante la importación del pedido.</p> <p>
                <p>También puede definir todos los demás métodos de pago disponibles en la lista de Shopware > Configuración > Métodos de pago y luego utilizarlos aquí.</p> <p>Este ajuste es importante para la impresión de facturas y albaranes, así como para el posterior procesamiento del pedido en la tienda y en el sistema.
