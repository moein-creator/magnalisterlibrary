...
class ML_Magento_Model_ProductListDependency_ManufacturerFilter extends ML_Shop_Model_ProductListDependency_ManufacturerFilter_Abstract {
    ...
    public function manipulateQuery($mQuery) {
        MLHelper::gi('model_productlistdependency_magentoattributefilter')->manipulateQuery(MLModule::gi()->getConfig('manufacturer'), $mQuery, $this->getFilterValue());
    }
    ...
    protected function getFilterValues() {
        return MLHelper::gi('model_productlistdependency_magentoattributefilter')->getFilterValues(MLModule::gi()->getConfig('manufacturer'));
    }
