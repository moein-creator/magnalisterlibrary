...
//                ;
                $mQuery->getSelectSql()->join(
                    array('catalog_category_product' => Mage::getSingleton('core/resource')->getTableName('catalog_category_product')), 
                    'catalog_category_product.product_id = e.entity_id AND catalog_category_product.category_id IN (\''.implode( "', '", $aCats).'\') ',
                    array()
                );
            }
        }
