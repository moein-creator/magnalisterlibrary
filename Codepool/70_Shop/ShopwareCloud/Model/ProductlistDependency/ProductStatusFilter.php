...
class ML_ShopwareCloud_Model_ProductListDependency_ProductStatusFilter extends ML_Shop_Model_ProductListDependency_ProductStatusFilter_Abstract {
    ...
    public function manipulateQuery($mQuery) {
        ...
        if (
            ...
            $mQuery->where("p.ShopwareActive = ".($sFilterValue == 'active' ? 1 : 0));
        }
    }
