...
class ML_ShopwareCloud_Model_Table_ShopwareCloudUnit extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_unit';

    protected $aFields = array(
        'ShopwareUnitID'   => array(
            'isKey' => true,
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwareUnitID'),
    );
