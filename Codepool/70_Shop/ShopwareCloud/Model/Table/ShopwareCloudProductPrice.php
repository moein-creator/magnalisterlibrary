...
class ML_ShopwareCloud_Model_Table_ShopwareCloudProductPrice extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_product_price';

    protected $aFields = array(
        'ShopwareProductPriceID'   => array(
            'isKey' => true,
            'Type'  => 'varchar(255)', 'Null' => self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => '',
        ),
        'ShopwareRuleID'   => array(
            'isKey' => true,
            'Type'  => 'varchar(255)', 'Null' => self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => '',
        ),
        'ShopwareProductID'   => array(
            'isKey' => true,
            'Type' => 'varchar(255)', 'Null' => self::IS_NULLABLE_NO, self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => '',
        ),
        'ShopwarePrice' => array(
            'Type' => 'longtext', 'Null' => self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => ''
        ),
        'ShopwareQuantityStart' => array(
            'Type' => 'int(11)', 'Null' => self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => ''
        ),
        'ShopwareQuantityEnd' => array(
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwareProductPriceID'),
    );
