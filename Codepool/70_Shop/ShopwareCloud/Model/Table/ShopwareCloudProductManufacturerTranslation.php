...
class ML_ShopwareCloud_Model_Table_ShopwareCloudProductManufacturerTranslation extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_product_manufacturer_translation';
    ...
    protected $aFields = array(
        ...
        'ShopwareProductManufacturerID' => array(
            'isKey' => true,
            'Type'  => 'varchar(255)', 'Null' => self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => ''
        ),
        'ShopwareName' => array(
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwareProductManufacturerID, ShopwareLanguageID'),
    );
