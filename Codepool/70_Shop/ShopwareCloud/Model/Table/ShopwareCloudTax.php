...
class ML_ShopwareCloud_Model_Table_ShopwareCloudTax extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_tax';
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwareTaxID'),
    );
