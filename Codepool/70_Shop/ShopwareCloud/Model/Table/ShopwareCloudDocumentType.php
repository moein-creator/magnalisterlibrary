...
class ML_ShopwareCloud_Model_Table_ShopwareCloudDocumentType extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_document_type';
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwareDocumentTypeId'),
    );
