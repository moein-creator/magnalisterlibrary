...
class ML_ShopwareCloud_Model_Table_ShopwareCloudCountryStateTranslation extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_country_state_translation';

    protected $aFields = array(
        'ShopwareCountryStateTranslationID'   => array(
            'isKey' => true,
            'Type'  => 'varchar(255)', 'Null' => self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => '',
        ),
        'ShopwareCountryStateID'   => array(
            'Type'  => 'varchar(255)', 'Null' => self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => '',
        ),
        'ShopwareCountryLanguageId'   => array(
            'isKey' => true,
            'Type'  => 'varchar(255)', 'Null' => self::IS_NULLABLE_NO, 'Default' => NULL, 'Extra' => '', 'Comment' => '',
        ),
        'ShopwareName' => array(
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwareCountryStateTranslationID'),
    );
    ...
    public function set($sName, $sValue) {
        if (in_array($sName, ['ShopwareActive'])) {
            if ($sValue === '') {
                $sValue = null;
            } else if ($sValue !== null) {
                $sValue = (int)$sValue;
