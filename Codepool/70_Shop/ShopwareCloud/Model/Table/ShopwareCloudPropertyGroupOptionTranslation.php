...
class ML_ShopwareCloud_Model_Table_ShopwareCloudPropertyGroupOptionTranslation extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_property_group_option_translation';

    protected $aFields = array(
        'ShopwarePropertyGroupOptionID'   => array(
            'isKey' => true,
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwarePropertyGroupOptionID , ShopwareLanguageID'),
    );
