...
class ML_ShopwareCloud_Model_Table_ShopwareCloudCountryState extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_country_state';
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwareCountryStateID'),
    );
