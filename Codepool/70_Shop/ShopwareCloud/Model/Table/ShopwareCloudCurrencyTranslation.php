...
class ML_ShopwareCloud_Model_Table_ShopwareCloudCurrencyTranslation extends ML_Database_Model_Table_Abstract {

    protected $sTableName = 'magnalister_shopwarecloud_currency_translation';

    protected $aFields = array(
        'ShopwareCurrencyTranslationID'   => array(
            'isKey' => true,
    ...
    protected $aTableKeys = array(
        'PRIMARY' => array('Non_unique' => '0', 'Column_name' => 'ShopwareCurrencyTranslationID'),
    );
