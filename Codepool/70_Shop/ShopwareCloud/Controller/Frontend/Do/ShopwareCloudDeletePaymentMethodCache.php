...
class ML_ShopwareCloud_Controller_Frontend_Do_ShopwareCloudDeletePaymentMethodCache extends ML_ShopwareCloud_Controller_Frontend_Do_ShopwareCloudAbstractCache {

    protected $sType = 'PaymentMethodDelete';
    protected $iLimitationOfIteration = 10;
    protected $sTranslationType = 'payment-method';
    ...
    protected function getEntities($preparedFilters) {
        ...
        $shippingMethods = $this->shopwareEntityRequest->getPaymentMethods('/api/search/' . $this->sTranslationType, 'POST', $preparedFilters);
