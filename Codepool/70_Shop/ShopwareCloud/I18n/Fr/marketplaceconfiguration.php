...
MLI18n::gi()->{'Shopware6_eBay_Marketplace_Configuration_fixedPriceoptions_label'} = 'Prix de vente de la règle de prix';
MLI18n::gi()->{'Shopware6_eBay_Marketplace_Configuration_chinesePriceoptions_label'} = 'Prix de la règle des prix';
MLI18n::gi()->{'Shopware6_eBay_Marketplace_Configuration_fixedPriceoptions_help'} = 'Avec cette fonction, vous pouvez transférer différents prix sur la place de marché et les synchroniser automatiquement.<br />
<br />
Sélectionnez une règle de prix de votre boutique en ligne en utilisant le menu déroulant à droite (voir ci-dessous).<br />
<br />
Si vous ne saisissez pas de prix dans la nouvelle règle de prix, le prix par défaut de la boutique en ligne sera automatiquement utilisé. Cela facilite grandement la saisie d\'un prix différent, même pour quelques articles seulement. Les autres configurations de prix sont également appliquées.<br />
<br />
<b>Exemple :</b>
<ul>
<li>Créez une règle de prix dans le menu Paramètres > Boutique > Constructeur de règles de votre boutique en ligne, par exemple, "{#setting:currentMarketplaceName#} clients".</li>
<li>Dans l\'édition des produits de votre boutique en ligne > Tarification avancée, ajoutez les prix souhaités aux articles.</li>
<ul>';
