...
abstract class ML_Prestashop_Model_ProductList_Abstract extends ML_Productlist_Model_ProductList_ShopAbstract {
    ...
    public function getMasterIds($blPage = false) {
        ...
        foreach ($aMainIds as $sId) {
            ...
            $oProduct = $oMLProduct->loadPrestashopProduct($sId);
            $aIds[] = $oMLProduct->loadByShopProduct($oProduct)->get('id');
        }
        return $aIds;
    }
