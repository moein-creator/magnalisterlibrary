...
?>
    ...
    Processing Time: <?php echo microtime2human($_executionTime - $_updaterTime - MagnaConnector::gi()->getRequestTime() - ML_Shopify_Helper_ShopifyInterfaceRequestHelper::gi()->getTotalRequestTime()); ?>.
    <br/>
    Shopify Api Request Time: <?php echo microtime2human(ML_Shopify_Helper_ShopifyInterfaceRequestHelper::gi()->getTotalRequestTime()); ?>. <br/>
    <hr/>
