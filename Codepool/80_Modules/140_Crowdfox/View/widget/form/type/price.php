...
<span style="display:table-cell;"><?php echo $this->__('ML_EBAY_PRICE_CALCULATED') ?></span><span style="display:table-cell;padding-right:1em;">:</span>
...
<script type="text/javascript">
    (function ($) {
        $(document).ready(function () {
            ...
            $('#crowdfox_prepare_apply_form_fieldset_details').hide();
            $('#crowdfox_prepare_apply_form_field_gtin').prop('disabled', true);
            $('#crowdfox_prepare_apply_form_field_price').closest('.js-field').hide();
            <?php endif ?>
        });
    })(jqml);
