...
<li>Además, también puede activar la conciliación de existencias (desde Tarifa Flat - máximo trimestral) con su propio CronJob invocando el siguiente enlace a su tienda:<br /><br />{#setting:sSyncInventoryUrl#}<br /><br />Se bloquean las llamadas a CronJob propios por parte de clientes que no estén en la tarifa Flat o que se ejecuten con una frecuencia superior a la trimestral.<br /><br /></li>
