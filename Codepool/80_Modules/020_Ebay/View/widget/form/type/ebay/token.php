...
$expires = '';
try {
    $expires .= MLModul::gi()->getConfig($aField['realname'].'.expires');
...
?>
<input class="mlbtn<?php echo $firstToken ?> action" type="button" value="<?php echo $this->__('ML_EBAY_BUTTON_TOKEN_NEW') ?>" id="requestToken<?php echo $aField['id']?>"/>
<?php echo $expires ?>
