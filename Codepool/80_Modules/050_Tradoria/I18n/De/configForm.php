    ...
    'field' => array(
        ...
        'checkin.taxmatching' => array(
            ...
            'matching' => array(
                ...
                'titledst' => 'Rakuten Steuers&auml;tze',
                'labelsdst' => array(
                    'Standard' => 'Standard',
...
MLI18n::gi()->add('tradoria_config_orderimport', array(
    ...
    'field' => array(
        'orderstatus.shipped' => array(
            ...
            'hint' => 'Bitte geben Sie die Werte auf Deutsch und vollständig ausgeschrieben an.<br><br>Die mit <span class="bull">&bull;</span> markierten Felder sind Pflichtfelder und müssen ausgefüllt werden. ',
            'help' => 'Setzen Sie hier den Shop-Status, der auf Rakuten automatisch den Status "Versand bestätigen" setzen soll.',
            'name' => 'Bestellstatus',
        ),
        'orderstatus.shipped.country' => array(
            'label' => 'Land<span class="bull">&bull;</span>',
        ),
        'orderstatus.shipped.city' => array(
            'label' => 'Stadt<span class="bull">&bull;</span>',
        ),
        'orderstatus.shipped.streetandnr' => array(
            'label' => 'Straße & Hausnummer',
        ),
        'orderstatus.shipped.zip' => array(
            'label' => 'Postleitzahl',
        ),
