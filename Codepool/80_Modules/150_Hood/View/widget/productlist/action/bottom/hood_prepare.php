    ...
    <div class="ml-container-action">
        <div class="ml-container-inner ml-container-md">
            <div>
                ...
                <a style="padding-left: 0; padding-right: 0;" class="mlbtn-gray ml-js-noBlockUi" id="ml-hood-prepare-reset-control"><?php echo $this->__('Hood_Productlist_Prepare_sResetValuesButton'); ?></a>
