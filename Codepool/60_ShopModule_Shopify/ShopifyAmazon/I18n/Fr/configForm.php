...
MLI18n::gi()->{'amazon_config_carrier_option_orderfreetextfield_option'} = 'magnalister ajoute un champ de texte dans les commandes sous “Informations supplémentaires”';
...
Vous pouvez faire correspondre les transporteurs proposés par Amazon avec les transporteurs créés dans le module d\'expédition de Shopify. Pour ajouter un nouvel appariement, cliquez sur le symbole "+".<br>
<br>
Pour savoir quelle entrée du module d\'expédition de Shopify est utilisée pour l\'importation des commandes Amazon, veuillez vous référer à l\'icône info sous "Importation des commandes" -> "Service d\'expédition des commandes".<br>
<br>
...
Vous pouvez faire correspondre les services de livraison proposés par Amazon avec les services de livraisons créés dans le module d\'expédition de Shopify. Pour ajouter un nouvel appariement, cliquez sur le symbole "+".<br>
<br>
Pour savoir quelle entrée du module d\'expédition de Shopify est utilisée pour l\'importation des commandes Amazon, veuillez vous référer à l\'icône info sous "Importation des commandes" -> "Service d\'expédition des commandes".<br>
<br>
Choisissez cette option si vous souhaitez <strong>utiliser les services d’expédition existants du module d’expédition de Shopify.</strong><br>
<ul>
	<li><span class="bold underline">magnalister ajoute un champ de texte dans les commandes sous “Informations supplémentaires”</span></li>
</ul>
Si vous sélectionnez cette option, un champ sera ajouté dans l’aperçu de la commande  dans la rubrique “Informations supplémentaires”dans Shopify dans lequel vous pouvez renseigner le service d’expédition.<br>
<br>
Choisissez cette option si vous souhaitez utiliser différents services d’expédition pour les commandes Amazon.<br>
<ul>
