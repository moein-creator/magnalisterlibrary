...
MLI18n::gi()->{'amazon_config_carrier_option_orderfreetextfield_option'} = 'magnalister fügt ein Freitextfeld unter “Weitere Details” in den Bestellungen hinzu';
...
Sie können die von Amazon empfohlenen Transportunternehmen mit den im Shopify Versandkosten-Modul angelegten Dienstleistern matchen. Über das “+” Symbol können Sie mehrere Matchings vornehmen.<br>
<br>
Infos, welcher Eintrag aus dem Shopify Versandkosten-Modul beim Amazon Bestellimport verwendet wird, entnehmen Sie bitte dem Info Icon unter “Bestellimport” -> “Versandart der Bestellungen”.<br>
<br>
Diese Option bietet sich an, wenn Sie auf <strong>bestehende Versandkosten-Einstellungen</strong> aus dem <strong>Shopify</strong> Versandkosten-Modul zurückgreifen möchten.<br>
<ul>
    <li><span class="bold underline">magnalister fügt ein Freitextfeld unter “Weitere Details” in den Bestellungen hinzu</span></li>
</ul>
Wenn Sie diese Option wählen, fügt magnalister beim Bestellimport ein Feld unter “Weitere Details” bei der Shopify Bestellung hinzu. In dieses Feld können Sie das Transportunternehmen eintragen.<br>
<br>
...
Sie können einen beliebigen Lieferservice mit den im Shopify Versandkosten-Modul angelegten Einträgen matchen. Über das “+” Symbol können Sie mehrere Matchings vornehmen.<br>
<br>
Infos, welcher Eintrag aus dem Shopify Versandkosten-Modul beim Amazon Bestellimport verwendet wird, entnehmen Sie bitte dem Info Icon unter “Bestellimport” -> “Versandart der Bestellungen”.<br>
<br>
Diese Option bietet sich an, wenn Sie auf <strong>bestehende Versandkosten-Einstellungen aus</strong> dem <strong>Shopify</strong> Versandkosten-Modul zurückgreifen möchten.<br>
<ul>
	<li><span class="bold underline">magnalister fügt ein Freitextfeld unter “Weitere Details” in den Bestellungen hinzu</span></li>
</ul>
Wenn Sie diese Option wählen, fügt magnalister beim Bestellimport ein Feld unter “Weitere Details” bei der Shopify Bestellung hinzu. In dieses Feld können Sie den Lieferservice eintragen.<br>
<br>
