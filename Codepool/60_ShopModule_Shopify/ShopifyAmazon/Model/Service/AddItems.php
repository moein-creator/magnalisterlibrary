...
MLFilesystem::gi()->loadClass('Amazon_Model_Service_AddItems');

class ML_ShopifyAmazon_Model_Service_AddItems extends ML_Amazon_Model_Service_AddItems {
    /**
     * set variation in master product data
     */
    protected function getProductArray() {
        $aData = parent::getProductArray();
