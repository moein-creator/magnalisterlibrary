...
MLI18n::gi()->{'cdiscount_config_orderimport__field__orderimport.paymentstatus__label'} = 'Payment Status in the Shop System';
...
<ul>
    ...
    <li>
        ...
        <p>You can match the shipping carriers suggested by Cdiscount with the service providers created in the Shopify shipping module. Add more than one match by clicking the "+" symbol.<br>
            <br>
            For information on which entry from the Shopify shipping module is used for the Cdiscount order import, please refer to the info icon under "Order Import" -> "Shipping Service of the Orders".<br>
            <br>
            Choose this option if you want to use <strong>existing shipping settings from the Shopify shipping module</strong>.<br>
        </p>
    </li>
    <li>
        <span class="bold underline">magnalister adds a free text field under "Additional Details" in the orders</span>
        <p>If you select this option, magnalister will add a field under "Additional Details" in the Shopify order when importing it. You can enter the shipping carrier in this field.<br>
            <br>
