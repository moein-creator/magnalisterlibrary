...
<ul>
    ...
    <li>
        ...
        <p>Sie können die von Cdiscount empfohlenen Transportunternehmen mit den im Shopify Versandkosten-Modul angelegten Dienstleistern matchen. Über das “+” Symbol können Sie mehrere Matchings vornehmen.<br>
            <br>
            Infos, welcher Eintrag aus dem Shopify Versandkosten-Modul beim Cdiscount Bestellimport verwendet wird, entnehmen Sie bitte dem Info Icon unter “Bestellimport” -> “Versandart der Bestellungen”.<br>
            <br>
            Diese Option bietet sich an, wenn Sie auf <strong>bestehende Versandart-Einstellungen</strong> aus dem <strong>Shopify</strong> Versandkosten-Modul zurückgreifen möchten.<br>
        </p>
    </li>
    <li>
        <span class="bold underline">magnalister fügt ein Freitextfeld unter “Weitere Details” in den Bestellungen hinzu</span>
        <p>Wenn Sie diese Option wählen, fügt magnalister beim Bestellimport ein Feld unter “Weitere Details” bei der Shopify Bestellung hinzu. In dieses Feld können Sie das Transportunternehmen eintragen.<br>
            <br>
