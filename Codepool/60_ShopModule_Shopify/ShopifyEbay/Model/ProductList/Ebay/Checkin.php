 ...
 *
 * Class ML_Shopify_Model_ProductList_Ebay_Checkin
 *
 */
MLFilesystem::gi()->loadClass('Shopify_Model_ProductList_UploadAbstract');
class ML_ShopifyEbay_Model_ProductList_Ebay_Checkin extends ML_Shopify_Model_ProductList_UploadAbstract {
