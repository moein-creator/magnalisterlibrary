...
class ML_ShopifyEbay_Model_ProductList_Ebay_Prepare_Apply extends ML_Shopify_Model_ProductList_Abstract {
    ...
    public function getSelectionName() {
     ...
     protected function executeFilter() {
        $this->oFilter
            ...
            ->registerDependency('marketplacesyncfilter', array('blPrepareMode' => true))
