 ...
 * -----------------------------------------------------------------------------
 */
MLI18n::gi()->set('dawanda_config_orderimport_automatic_method', '-- Automatisch zuordnen --', true);
     ...
     'field' => array(
        'orderimport.paymentmethod' => array(
            ...
            'help' => '
                ...
                <p>Alle weiteren verf&uuml;gbaren Zahlarten in der Liste k&ouml;nnen Sie ebenfalls unter Shopify > Einstellungen > Zahlungsarten definieren und hier&uuml;ber dann verwenden.</p>
        ...
        'orderimport.shippingmethod' => array(
            ...
            'help' => '
                ...
                <p>W&auml;hlen Sie daher bitte hier die verf&uuml;gbaren Web-Shop-Versandarten. Die Inhalte aus dem Drop-Down k&ouml;nnen Sie unter Shopify > Einstellungen > Versandkosten definieren.</p>
                <p>Diese Einstellung ist wichtig f&uuml;r den Rechnungs- und Lieferscheindruck, und f&uuml;r die nachtr&auml;gliche Bearbeitung der Bestellung im Shop, sowie in Warenwirtschaften.</p>',
           'hint' => '',
        ),
