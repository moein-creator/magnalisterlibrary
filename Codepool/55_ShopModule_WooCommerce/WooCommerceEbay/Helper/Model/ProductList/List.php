 ...
 * -----------------------------------------------------------------------------
 */
MLFilesystem::gi()->loadClass('WooCommerce_Helper_Model_ProductList_List');

class ML_WooCommerceEbay_Helper_Model_ProductList_List extends ML_WooCommerce_Helper_Model_ProductList_List {
