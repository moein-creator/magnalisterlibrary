 ...
 * -----------------------------------------------------------------------------
 */
MLFilesystem::gi()->loadClass('WooCommerce_Model_ProductList_UploadAbstract');
class ML_WooCommerceGoogleShopping_Model_ProductList_GoogleShopping_Checkin extends ML_WooCommerce_Model_ProductList_UploadAbstract {
