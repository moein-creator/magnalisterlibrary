...
MLI18n::gi()->{'amazon_config_carrier_option_orderfreetextfield_option'} = 'magnalister adds a “Custom Field” in the order details';
...
You can match the shipping carriers suggested by Amazon with the service providers created in the WooCommerce shipping module. Add more than one match by clicking the "+" symbol.<br>
<br>
For information on which entry from the WooCommerce shipping module is used for the Amazon order import, please refer to the info icon under "Order Import" -> "Shipping Service of the Orders".<br>
<br>
Choose this option if you want to use <strong>existing shipping settings from the WooCommerce shipping module</strong>.<br>
<ul>
    <li><span class="bold underline">magnalister adds a “Custom Field” in the order details</span></li>
</ul>
If you select this option, magnalister will add a “Custom Field” in the order details of the WooCommerce order when importing it. You can enter the shipping carrier in this field.<br>
<br>
...
You can match any shipping method with the entries created in the WooCommerce shipping module. Add more than one match by clicking the "+" symbol.<br>
<br>
For information on which entry from the WooCommerce shipping module is used for the Amazon order import, please refer to the info icon under "Order Import" -> "Shipping Service of the Orders".<br>
<br>
Choose this option if you want to use <strong>existing shipping settings from the WooCommerce shipping module.</strong><br>
...
If you select this option, magnalister will add a “Custom Field” in the order details in the WooCommerce order when importing it. You can enter the shipping method in this field.<br>
<br>
