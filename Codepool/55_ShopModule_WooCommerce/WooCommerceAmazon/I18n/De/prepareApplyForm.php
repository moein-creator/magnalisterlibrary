...
MLI18n::gi()->{'amazon_prepare_apply_form__field__bulletpoints__hint'} = 'Key-Features des Artikels (z. B. "Vergoldete Armaturen", "Extrem edles Design")<br /><br />Diese Daten werden aus "Produkt Kurzbeschreibung" gezogen und müssen dort mit Kommas getrennt sein.<br />Maximal je 500 Zeichen.';
MLI18n::gi()->{'amazon_prepare_apply_form__field__bulletpoints__optional__checkbox__labelNegativ'} = 'Bulletpoints immer aktuell aus Web-Shop verwenden (Produkt Kurzbeschreibung)';
...
1. Keywords immer aktuell aus Web-Shop verwenden (Produkt Schlagwörter): 
<br><br>
Dabei werden die Schlüsselwörter aus dem Produkt-Schlagwörter-Feld des jeweiligen Produktes im Web-Shop gezogen und an Amazon übermittelt.
<br><br>
2. Allgemeine Schlüsselwörter in magnalister manuell eintragen: 
<br><br>
Wenn Sie nicht die am Web-Shop-Produkt hinterlegten Produkt Schlagwörter übernehmen möchten, können Sie eigene Schlüsselwörter in diesem Freitextfeld eintragen.
<br><br>
...
Wenn im Produkt-Schlagwörter-Feld des Web-Shop-Produkts die Keywords kommagetrennt vorliegen, wandelt magnalister beim Produkt-Upload die Kommas automatisch in Leerzeichen um. Auch hier gilt die Begrenzung auf 250 Bytes.
</li><li>
...
';
MLI18n::gi()->{'amazon_prepare_apply_form__field__keywords__optional__checkbox__labelNegativ'} = 'Keywords immer aktuell aus Web-Shop verwenden (Produkt Schlagwörter)';