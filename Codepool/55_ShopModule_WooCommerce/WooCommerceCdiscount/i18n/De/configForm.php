...
<ul>
    ...
    <li>
        <span class="bold underline">Von Cdiscount vorgeschlagene Transportunternehmen mit Versanddienstleistern aus den Webshop-Versandarten matchen</span>
        <p>Sie können die von Cdiscount empfohlenen Transportunternehmen mit den in den WooCommerce-Versandart angelegten Dienstleistern matchen. Über das “+” Symbol können Sie mehrere Matchings vornehmen.<br>
            <br>
            Infos, welcher Eintrag aus den WooCommerce-Versandarten beim Cdiscount Bestellimport verwendet wird, entnehmen Sie bitte dem Info Icon unter “Bestellimport” -> “Versandart der Bestellungen”.<br>
            <br>
    ...
    <li>
        <span class="bold underline">magnalister fügt ein “Individuelles Feld” in den Bestelldetails hinzu</span>
        <p>Wenn Sie diese Option wählen, fügt magnalister beim Bestellimport ein Feld in den Bestelldetails bei der WooCommerce Bestellung hinzu. In dieses Feld können Sie das Transportunternehmen eintragen.<br>
            <br>
