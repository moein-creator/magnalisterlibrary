...
<ul>
    ...
    <li>
        ...
        <p>Vous pouvez faire correspondre les transporteurs proposés par Cdiscount avec les transporteurs créés dans le module d\'expédition de WooCommerce. Pour ajouter un nouvel appariement, cliquez sur le symbole "+".<br>
            <br>
            Pour savoir quelle entrée du module d\'expédition de WooCommerce est utilisée pour l\'importation des commandes Cdiscount, veuillez vous référer à l\'icône info sous "Importation des commandes" -> "Service d\'expédition des commandes".<br>
            <br>
    ...
    <li>
        ...
        <p>Si vous sélectionnez cette option, un champ sera ajouté dans l’aperçu de la commande dans WooCommerce dans lequel vous pouvez renseigner la société de livraison.<br>
            <br>
