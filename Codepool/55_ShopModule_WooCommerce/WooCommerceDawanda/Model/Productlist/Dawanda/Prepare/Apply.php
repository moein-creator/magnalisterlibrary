...
class ML_WooCommerceDawanda_Model_ProductList_Dawanda_Prepare_Apply extends ML_WooCommerce_Model_ProductList_Abstract {
    ...
    protected function executeFilter(){
        $this->oFilter
            ...
            ->registerDependency('dawandapreparetypefilter', array('PrepareType' => 'apply'))
