...
MLI18n::gi()->{'configform_price_field_strikeprice_help'} = 'Prix barr&eacute; sur {#setting:currentMarketplaceName#}:Cette option vous permet d’afficher un prix au rabais ou le prix de détail suggéré par le fabricant (PDSF).<br /><br />
<b>Important:</b><br />
<ul>
...
MLI18n::gi()->{'ML_EBAY_PRICE_CALCULATED'} = 'Prix <small>(résultant des paramètres rentrés précédemment)</small>';
