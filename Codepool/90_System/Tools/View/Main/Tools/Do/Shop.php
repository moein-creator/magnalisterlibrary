        ...
        <tr class=""><?php
            ...
            <td><?php
                try {
                    ...
                    ?>
                    <a class="ml-js-noBlockUi" style="float:left;" target="_blank" href="<?php echo $this->getUrl(array('do' => $sDo, 'offset' => 0)); ?>"><?php echo $sDo; ?></a><?php
                    ?>
                <a class="ml-js-noBlockUi" style="float:right;" target="_blank" href="<?php echo $this->getFrontendDoUrl(array('do' => $sDo, 'auth' => md5(MLShop::gi()->getShopId().trim(MLDatabase::factory('config')->set('mpid', 0)->set('mkey', 'general.passphrase')->get('value'))), 'offset' => 0)); ?>">
                        (Frontend)</a><?php
                } catch (Exception $oEx) {
                    $aExceptions[] = $oEx;
                    echo $sDo;
